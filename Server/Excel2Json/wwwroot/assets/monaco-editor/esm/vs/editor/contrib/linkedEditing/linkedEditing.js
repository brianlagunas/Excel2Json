...
let LinkedEditingContribution = class LinkedEditingContribution extends Disposable {
    constructor(editor, contextKeyService) {
        ...
        this._register(this._editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(60 /* linkedEditing */) || e.hasChanged(80 /* renameOnType */)) {
    ...
    reinitialize(forceRefresh) {
        ...
        const isEnabled = model !== null && (this._editor.getOption(60 /* linkedEditing */) || this._editor.getOption(80 /* renameOnType */)) && LinkedEditingRangeProviderRegistry.has(model);
