...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    pushUndoStop() {
        ...
        if (this._configuration.options.get(79 /* readOnly */)) {
    ...
    getScrolledVisiblePosition(rawPosition) {
        ...
        return {
            top: top,
            left: left,
            height: options.get(57 /* lineHeight */)
        };
    }
    ...
    applyFontInfo(target) {
        Configuration.applyFontInfoSlow(target, this._configuration.options.get(41 /* fontInfo */));
    }
    _attachModel(model) {
        if (!model) {
            this._modelData = null;
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorReadonly.set(options.get(79 /* readOnly */));
        this._inDiffEditor.set(options.get(52 /* inDiffEditor */));
